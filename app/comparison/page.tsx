      ...
      <div className="container mx-auto max-w-6xl space-y-12 px-4 py-8 sm:space-y-16 sm:px-6 sm:py-12 lg:px-8">
        ...
        <section className="space-y-4 sm:space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground sm:text-base">Two tools, two different purposes</p>
          </div>
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">Visual placeholder during data loading</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground sm:text-sm">Design → Build → Add loading states</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 sm:space-y-4">
                ...
                <div>
                  <p className="mb-2 text-xs font-medium sm:text-sm">Workflow</p>
                  <p className="text-xs text-muted-foreground sm:text-sm">Prototype → Migrate to production</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="space-y-4 sm:space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground sm:text-base">Side-by-side technical assessment</p>
          </div>
            ...
            <table className="w-full min-w-[600px]">
              <thead className="border-b bg-muted/50">
                <tr>
                  ...
                  <th className="p-2 text-left text-xs font-medium sm:p-4 sm:text-sm">wireframe-ui</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                <tr>
                  <td className="p-2 text-xs font-medium sm:p-4 sm:text-sm">Primary Purpose</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">Loading indicator</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">Prototyping system</td>
                </tr>
                <tr>
                  <td className="p-2 text-xs font-medium sm:p-4 sm:text-sm">Component Variety</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">1 component</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">10+ semantic components</td>
                </tr>
                <tr>
                  <td className="p-2 text-xs font-medium sm:p-4 sm:text-sm">Structure Preservation</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">No</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">Yes (~85%)</td>
                </tr>
                <tr>
                  <td className="p-2 text-xs font-medium sm:p-4 sm:text-sm">Production Migration</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">Not applicable</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">Built-in</td>
                </tr>
                <tr>
                  <td className="p-2 text-xs font-medium sm:p-4 sm:text-sm">Bundle Size</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">~1KB (minimal)</td>
                  <td className="p-2 text-xs text-muted-foreground sm:p-4 sm:text-sm">~8KB (moderate)</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="space-y-4 sm:space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground sm:text-base">Choose the right tool for your needs</p>
          </div>
        ...
        <section className="space-y-4 sm:space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground sm:text-base">Every tool has trade-offs</p>
          </div>
        ...
        {/* Disclaimer */}
        <section className="space-y-2 text-center text-xs text-muted-foreground sm:text-sm">
          <p>
